package com.google.fastcf.List_tintuc;
...
public class NoiDungAdaptar extends BaseAdapter {
    private Context context;
    private int layout;
    private List<NoiDung> noiDungList;

    public NoiDungAdaptar(Context context, int layout, List<NoiDung> noiDungList) {
